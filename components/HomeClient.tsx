...
export default function HomeClient() {
  ...
  const checkDailyCount = () => {
    ...
    if (storedDate === today && storedCount) {
      setDailySims(parseInt(storedCount));
    } else {
      localStorage.setItem('dailySimDate', today);
      localStorage.setItem('dailySims', '0');
    }
  };
    ...
    <main className="min-h-screen bg-gray-900 text-white flex flex-col">
      <SignedIn>
        ...
        <div className="p-4 flex flex-col md:flex-row md:items-center gap-2">
          ...
          <button
            onClick={() => {
              const refreshed = generateOneMinCandles(1000);
              setAllCandles(refreshed);
              applyTimeframe(refreshed, timeframe);
            }}
            className="bg-yellow-500 p-2 rounded hover:bg-yellow-400"
          >
            Refresh Chart
          </button>
        </div>
          ...
          <section className="bg-gray-800 p-4 rounded-lg shadow">
            ...
            <div className="mt-4">
              <h3 className="text-sm mb-1">
                Daily Progress ({dailySims}/{DAILY_GOAL} Sims Completed)
              </h3>
              ...
              {dailySims >= DAILY_GOAL && (
                <p className="text-green-400 text-sm mt-2">
                  Bonus unlocked! Keep going for more practice.
                </p>
              )}
            </div>
          </section>
            ...
            <div className="space-y-3">
              ...
              <label className="block">
                ...
                <input
                  ...
                  placeholder="Leave blank to wait..."
                />
              </label>
              <label className="block">
                Take Profit:
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  className="mt-1 w-full p-2 bg-gray-700 rounded h-20"
              ...
              <button
                ...
                disabled={tokens <= 0 && !subscriptionActive}
                className={`w-full p-2 rounded ${
                  tokens > 0 || subscriptionActive
              ...
              <button
                ...
                disabled={tokens <= 0 && !subscriptionActive}
                className={`w-full p-1 mt-1 rounded text-xs ${
                  tokens > 0 || subscriptionActive
              ...
              {!subscriptionActive && (
                <button
                  ...
                  className="bg-blue-600 text-white w-full p-2 rounded hover:bg-blue-500 mt-2"
                >
                  Upgrade to Premium
                </button>
              )}
              ...
              <div className="space-y-2 pt-4">
                <p
                  ...
                  onClick={() => (window.location.href = '/upgrade')}
                >
                  Simulations Remaining: {tokens >= 9999 ? 'Unlimited' : tokens}{' '}
                  {!subscriptionActive && '(Need more?)'}
                </p>
                <p
                ...
                >
                  Subscription Status:{' '}
                  {subscriptionActive ? 'Premium Plan' : 'Free Plan (3 Sims)'}
                </p>
              </div>
            </div>
          </section>
        ...
        <footer className="bg-gray-800 p-4 border-t border-gray-700">
          ...
          <div className="bg-gray-700 p-4 rounded text-gray-200 border border-green-500">
            {feedback}
          </div>
          {tradeScore !== null && (
      ...
      <SignedOut>
        <div className="min-h-screen flex justify-center items-center">
          <p className="text-white text-xl">
            Please <a href="/sign-in" className="text-blue-500">sign in</a> to access TradeSim AI.
          </p>
        </div>
      </SignedOut>
    </main>
